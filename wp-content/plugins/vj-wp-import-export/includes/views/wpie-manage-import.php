                                                        ...
                                                        foreach ( $templates as $template ) {
                                                                ...
                                                                <tr class="wpie_log_wrapper wpie_log_wrapper_<?php echo esc_attr( $id ); ?>">
                                                                        ...
                                                                        <td class="wpie_log_data wpie_action_<?php echo esc_attr( $status ); ?>" >                                       
                                                                                ...
                                                                                <a  class="wpie_log_action_btns wpie_process_reimport_btn" href="<?php echo esc_url( add_query_arg( [ 'page' => 'wpie-new-import', 'import_id' => $id, 'ref_id' => $uid, 'nonce' => wp_create_nonce( $id . $uid ) ], admin_url( "admin.php" ) ) ); ?>"><i class="fas fa-redo-alt wpie_general_btn_icon wpie_data_tipso" data-tipso="<?php esc_attr_e( 'Reimport', 'vj-wp-import-export' ); ?>" aria-hidden="true"></i></a>
