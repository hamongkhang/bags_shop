<div class="wpie_acf_item_wrapper wpie_as_specified_wrapper" >
    ...
    <i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e("Specify the hex code the color preceded with a # - e.g. #000000.", "vj-wp-import-export"); ?>"></i>
</div>