 ...
 * @version  2.6.0
 */
abstract class APPMAKER_WC_REST_Controller extends WP_REST_Controller {
	/**
	 ...
	 * @var string
	 */
	protected $namespace = 'appmaker-wp/v2';
	/**
	 * Route base.
	 *
	 * @var string
	...
	/**
	 * APPMAKER_WC_REST_Controller constructor.
	 */
	...
	public function api_permissions_check( $request, $method = '' ) {
		if ( ! $this->options ) {
			return new WP_Error( 'rest_forbidden_context', __( 'Plugin not configureded' ), array( 'status' => rest_authorization_required_code() ) );
		}
